...
CREATE TABLE `__new_sets` (
	...
	`rir` integer,
	`created_at` integer DEFAULT 1768522256666,
...
ALTER TABLE `routine_exercises` ADD `target` text;--> statement-breakpoint
ALTER TABLE `routine_exercises` ADD `notes` text;
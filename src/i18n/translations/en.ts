export const en = {
  ...
  bio: {
    ...
    open: 'Open',
    openMonthlyCheckinHint: 'Opens the monthly check-in form',
    front: 'Front',
    back: 'Back',
    side: 'Side',
    photoNotes: 'Notes...',
  ...
  routines: {
    ...
    saveFirstForTemplate: 'Save the routine first before making it a template',
    ...
    folderManagerDescription: 'Create, rename, or delete folders. Deleting a folder moves its routines to General.',
    ...
    folderSelectionHint: 'Choose the folder for this routine.',
    folderNameRequired: 'Enter a folder name.',
    folderNameTooLong: 'Folder names can be at most 50 characters.',
    folderAlreadyExists: 'A folder with this name already exists.',
    folderCannotChangeDefault: 'The General folder is protected.',
    folderNotFound: 'Folder not found.',
    folderOperationError: 'Failed to update folders.',
    deleteFolderTitle: 'Delete folder',
    deleteFolderMessage: 'Routines in this folder will move to General. Delete "{name}"?',
    strength: 'Strength',
  ...
  history: {
    ...
    selectDayPrompt: 'Select a day to view your workouts',
    view: 'View',
  ...
  session: {
    ...
    exerciseProgressSingular: '{current} of {total} exercise',
  ...
  finish: {
    ...
    lastWeight: 'Last: {weight}kg ({date})',
  ...
  summary: {
    ...
    reportTarget: 'Target',
    verdicts: {
      title: 'Coaching Verdicts',
      result: 'Result',
      verdict: 'Verdict',
      confidence: 'Confidence',
      nextLoad: 'Next Load',
      flags: 'Flags',
      resultTop: 'Top of range',
      resultWithin: 'Within range',
      resultBelow: 'Below range',
      resultNoTarget: 'No target',
      verdictIncrease: 'Increase load',
      verdictHold: 'Hold load',
      verdictReviewFatigue: 'Review fatigue',
      verdictCheckLogging: 'Check logging',
      confidenceHigh: 'High',
      confidenceMedium: 'Medium',
      confidenceLow: 'Low',
      suggestIncreaseNumeric: 'Next time try {weight}kg',
      suggestIncreaseGeneric: 'Increase load next session',
      suggestHold: 'Maintain current load',
      suggestReviewFatigue: 'Lower load or rest more',
      suggestCheckLogging: 'Verify logged sets details',
      flagRirInversion: 'Suspicious RIR inconsistency',
      flagAbruptRepDrop: 'Abrupt rep drop between sets',
      flagExtraSets: 'Extra sets beyond target',
      flagRepeatedBelowRange: 'Repeated below-range sets',
    },
  },
  settings: {
    title: 'Settings',
  ...
  bioAnalytics: {
    ...
    sessionCount30d: 'Sessions (30 days)',
    period30d: 'Last 30 days',
    period12Weeks: 'Last 12 weeks',
    ...
    insights: 'Insights',
    noWeightHistory: 'No weight history found',
    weightChartHint: 'Log another weight to show the chart',
    noVolumeDistribution: 'No volume distribution data',
    noWeeklyVolume: 'No training volume in this period',
    newExercise: 'New exercise',
    previousValue: 'Previous: {value}',
    insightVolumeUnavailableDesc: 'Log workouts in both periods to compare volume.',
    insightVolumeUpTitle: 'Volume on the rise',
    insightVolumeUpDesc: 'Your total volume increased by {value}% in the last 30 days. Keep progressing!',
    insightVolumeDownTitle: 'Active recovery',
    insightVolumeDownDesc: 'Your total volume decreased by {value}% in the last 30 days. Focus on recovery.',
    insightVolumeStableTitle: 'Constant volume',
  ...
  bioEvolution: {
    ...
    weightLabel: 'Weight',
    armLabel: 'Arm',
    movingAverageLabel: 'Average of last 7 entries',
  ...
  routineDetail: {
    ...
    workoutCountSingle: '{count} workout',
  ...
  programs: {
    ...
    restLabel: 'Rest',
    notesLabel: 'Notes',
    noPlannedExercises: 'No routine or exercise planned for this week',
    title: 'Programs',

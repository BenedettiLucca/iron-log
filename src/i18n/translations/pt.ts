export const pt = {
  ...
  bio: {
    ...
    open: 'Abrir',
    openMonthlyCheckinHint: 'Abre o formulário do check-in mensal',
    front: 'Frente',
    back: 'Costas',
    side: 'Lateral',
    photoNotes: 'Notas...',
  ...
  routines: {
    ...
    addExercisesFirst: 'Adicione exercícios primeiro',
    ...
    saveTemplateError: 'Falha ao salvar modelo.',
    saveFirstForTemplate: 'Salve a rotina primeiro antes de torná-la um modelo',
    ...
    folder: 'Pasta',
    folderManager: 'Gerenciar pastas',
    folderManagerDescription: 'Crie, renomeie ou exclua pastas. Excluir uma pasta move suas rotinas para Geral.',
    newFolder: 'Nova pasta',
    createFolder: 'Criar pasta',
    renameFolder: 'Renomear pasta',
    deleteFolder: 'Excluir pasta',
    folderName: 'Nome da pasta',
    folderNamePlaceholder: 'Ex: Push',
    folderDefault: 'Padrão',
    folderSelectionHint: 'Escolha a pasta desta rotina.',
    folderNameRequired: 'Digite um nome para a pasta.',
    folderNameTooLong: 'O nome da pasta pode ter no máximo 50 caracteres.',
    folderAlreadyExists: 'Já existe uma pasta com esse nome.',
    folderCannotChangeDefault: 'A pasta Geral é protegida.',
    folderNotFound: 'Pasta não encontrada.',
    folderOperationError: 'Falha ao atualizar as pastas.',
    deleteFolderTitle: 'Excluir pasta',
    deleteFolderMessage: 'As rotinas desta pasta voltarão para Geral. Deseja excluir "{name}"?',
    strength: 'Força',
  ...
  history: {
    ...
    selectDayPrompt: 'Selecione um dia para ver seus treinos',
    view: 'Ver',
  ...
  session: {
    ...
    dontAskAgainHint: 'Alterna se este aviso será exibido novamente.',
    recoveryDismiss: 'Fechar aviso de recuperação de treino',
    recoveryDismissHint: 'Fecha o aviso sem retomar o treino atual.',
    resume: 'Retomar',
    ...
    exerciseProgressSingular: '{current} de {total} exercício',
  ...
  // Set Card
  setCard: {
    accessibilityLabel: 'Série {setNumber}, {details}',
    actionsHint: 'Deslize para a esquerda ou use o botão de ações para editar ou excluir.',
    actionsTitle: 'Ações da série',
    openActions: 'Abrir ações da série',
    noWeight: 'sem carga',
    durationSeconds: '{duration}s',
    repsCount: '{reps} repetições',
    rir: 'RIR {rir}',
    warmup: 'Aquecimento',
    edited: 'Editado',
  ...
  summary: {
    ...
    reportTarget: 'Meta',
    verdicts: {
      title: 'Vereditos de Treino',
      result: 'Resultado',
      verdict: 'Veredito',
      confidence: 'Confiança',
      nextLoad: 'Carga Seguinte',
      flags: 'Sinais',
      resultTop: 'Topo da meta',
      resultWithin: 'Dentro da meta',
      resultBelow: 'Abaixo da meta',
      resultNoTarget: 'Sem meta',
      verdictIncrease: 'Aumentar carga',
      verdictHold: 'Manter carga',
      verdictReviewFatigue: 'Revisar fadiga',
      verdictCheckLogging: 'Verificar registro',
      confidenceHigh: 'Alta',
      confidenceMedium: 'Média',
      confidenceLow: 'Baixa',
      suggestIncreaseNumeric: 'Da próxima vez tente {weight}kg',
      suggestIncreaseGeneric: 'Aumentar a carga na próxima sessão',
      suggestHold: 'Manter a carga atual',
      suggestReviewFatigue: 'Reduzir carga ou descansar mais',
      suggestCheckLogging: 'Verificar detalhes das séries registradas',
      flagRirInversion: 'Inconsistência de RIR suspeita',
      flagAbruptRepDrop: 'Queda abrupta de repetições entre séries',
      flagExtraSets: 'Séries extras além do planejado',
      flagRepeatedBelowRange: 'Séries repetidas abaixo da meta',
    },
  },
  ...
  settings: {
    ...
    exportManifest: 'Exportar Manifest',
    exportManifestBtn: 'Exportar Manifest',
    manifestExportSuccess: 'Manifest exportado com sucesso!',
    manifestExportError: 'Falha ao exportar manifest.',
  ...
  bioAnalytics: {
    ...
    sessionCount30d: 'Sessões (30 dias)',
    period30d: 'Últimos 30 dias',
    period12Weeks: 'Últimas 12 semanas',
    noComparison: 'Sem comparação anterior',
    stable: 'Estável',
    avgSrpe: 'sRPE médio',
    avgDuration: 'Duração média',
    ...
    insights: 'Insights',
    noWeightHistory: 'Nenhum histórico de peso encontrado',
    weightChartHint: 'Registre mais um peso para exibir o gráfico',
    noVolumeDistribution: 'Sem dados de distribuição de volume',
    noWeeklyVolume: 'Sem volume de treino neste período',
    newExercise: 'Novo exercício',
    previousValue: 'Anterior: {value}',
    insightVolumeUnavailableDesc: 'Registre treinos nos dois períodos para comparar o volume.',
    insightVolumeUpTitle: 'Volume em alta',
    insightVolumeUpDesc: 'Seu volume total aumentou {value}% nos últimos 30 dias. Continue progredindo!',
    insightVolumeDownTitle: 'Recuperação ativa',
    insightVolumeDownDesc: 'Seu volume total diminuiu {value}% nos últimos 30 dias. Foco na recuperação.',
    insightVolumeStableTitle: 'Volume constante',
    insightVolumeStableDesc: 'Seu volume de treino permaneceu estável nos últimos 30 dias.',
    insightFrequencyTitle: 'Frequência de treinos',
    insightFrequencyDesc: '{value} treinos/semana na média das últimas 12 semanas.',
    activityHeatmap: 'Atividade Anual',
    heatmapSubtitle: 'Treinos nos últimos 365 dias',
    heatmapLess: 'Menos',
    heatmapMore: 'Mais',
    heatmapTotalWorkouts: '{count} treinos',
    heatmapActiveDays: '{count} dias ativos',
    heatmapTotalHours: '{hours}h {minutes}m',
    heatmapNoWorkouts: 'Nenhum treino',
    heatmapDayA11y: '{date}: {sessions} treinos, {minutes} min',
    heatmapDayEmptyA11y: '{date}: sem treinos',
  },
  ...
  bioEvolution: {
    ...
    weightLabel: 'Peso',
    armLabel: 'Braço',
    movingAverageLabel: 'Média das últimas 7 medições',
  ...
  routineDetail: {
    ...
    workoutCount: '{count} treinos',
    workoutCountSingle: '{count} treino',
  ...
  programs: {
    ...
    maxReps: 'Até {max} reps',
    weeklyTargets: 'Metas da semana',
    targetRir: 'RIR alvo',
    intensity: 'Intensidade',
    blockPhase: 'Fase do bloco',
    plannedExercises: 'Exercícios planejados',
    targetLabel: 'Meta',
    restLabel: 'Descanso',
    notesLabel: 'Observações',
    noPlannedExercises: 'Nenhuma rotina ou exercício planejado para esta semana',
    title: 'Programas',
    ...
    loadError: 'Erro ao carregar programa',

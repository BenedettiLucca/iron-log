...
export function useSessions() {
  ...
  const [incompleteSession, setIncompleteSession] = useState<(Session & { sessionId?: number; exerciseId?: number; exerciseName?: string; target?: string | null; notes?: string | null; routineExerciseId?: number | null; restSeconds?: number | null }) | null>(null);
